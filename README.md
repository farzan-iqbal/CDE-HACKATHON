...
| **Database** | PostgreSQL 15 | Store cleaned, structured product data |
...
| Report | Description |
|---|---|
| `category_count.png` | Bar chart showing product count per category |
| `price_distribution.png` | Histogram of product price spread |
| `top_categories.png` | Top N categories by listing volume |
| `avg_price_by_category.png` | Average price comparison across categories |
